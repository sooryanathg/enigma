...
export const TutorialTile = ({
  ...
  return (
    <div
      ...
      className={`group tile overflow-visible day-cell w-full h-full px-2 flex items-center justify-center  text-[8px] lg:text-[10px] font-whirlyBirdie font-bold border bg-black text-white border-white/20
