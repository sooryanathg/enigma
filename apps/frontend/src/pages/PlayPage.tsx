...
const DayBox = ({
  ...
  <>
    <div
      className="absolute bg-white w-[126.08px] h-[94px]"
      style={{ left, top }}
    />
    <div
      className="absolute font-whirlyBirdie font-bold text-black text-center w-[89px] h-[24px] text-[20px] leading-[24px] whitespace-nowrap"
      style={{ left: `${parseFloat(left) + 18}px`, top: dayTop }}
    >
      day {day}
    </div>
    <div
      className="absolute font-poppins font-medium text-black text-center w-[105px] h-[24px] text-[16px] leading-[24px]"
      ...
      >
        ...
        <div className="absolute w-[216px] h-[73px] left-[731px] top-[851px]">
          <Button
            ...
            className="w-full h-full bg-black text-white font-whirlyBirdie font-bold hover:bg-gray-800 disabled:opacity-50 flex items-center justify-center text-[24px] leading-[29px]"
          >
            {submitting
              ? "Submitting..."
              : cooldownSeconds > 0
        ...
        <div className="absolute bg-black w-[514px] h-[675px] left-[968.02px] top-[249px]">
          ...
          {DAY_BOXES.map(({ day, left, top, dayTop, statusTop }, idx) => (
            <DayBox
              ...
              dayTop={dayTop}
              statusTop={statusTop}
              isCompleted={progress?.progress[idx]?.isCompleted}
            />
          ))}
          ...
          <div className="grid grid-cols-3 gap-3">
            {DAY_BOXES.map(({ day }, idx) => (
              <div key={day} className="bg-white rounded p-3 text-center">
                <div className="font-whirlyBirdie font-bold text-black text-sm mb-1 whitespace-nowrap">
                  day {day}
                </div>
                <div className="font-poppins font-medium text-black text-xs">
                  {progress?.progress[idx]?.isCompleted
                    ? "Completed"
                    : "In Progress"}
                </div>
              </div>
